...
const NewsArticle8 = () => {
  const articleData = {
    ...
    content: [
      ...
      "<img src='/lovable-uploads/534e562b-7d55-419b-9338-8b11ba73822a.png' alt='مدينة دوسلدورف' className='w-full object-cover' />",
      "<p className='text-center text-sm text-text/60 mt-2'>مدينة دوسلدورف الجميلة حيث أقيم المعرض</p>",
      "</div>",
      ...
      "<div className='my-8 rounded-lg overflow-hidden'>",
      "<img src='/lovable-uploads/8c324ef5-5b5a-47dd-a360-70b88c4b4674.png' alt='معرض EuroCIS' className='w-full object-cover' />",
      "<p className='text-center text-sm text-text/60 mt-2'>جانب من معرض EuroCIS وتواجد الشركات العالمية</p>",
      "</div>",
      ...
      "<div className='my-8 rounded-lg overflow-hidden'>",
      "<img src='/lovable-uploads/4582455b-f853-4b5b-8d0c-3fa8609f3c08.png' alt='المعرض من الداخل' className='w-full object-cover' />",
      "<p className='text-center text-sm text-text/60 mt-2'>صورة من داخل المعرض تظهر تفاعل الزوار مع أحدث التقنيات</p>",
      "</div>",
