...
const NewsArticle8 = () => {
  const articleData = {
    ...
    content: [
      ...
      "<div className='my-10 rounded-lg overflow-hidden shadow-md'>",
      "<img src='/lovable-uploads/1f1a3c21-8499-4e8e-847d-49ff8212b3cf.png' alt='بطاقات ولاء' className='w-full object-cover' />",
      "<p className='text-center text-sm text-text/60 mt-2'>تقنيات حديثة لبطاقات الولاء وتخصيص المكافآت</p>",
      "</div>",
