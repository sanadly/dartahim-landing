...
const NewsArticle8 = () => {
  const articleData = {
    ...
    content: [
      ...
      "<img src='/lovable-uploads/eurocis-1.png' alt='معرض EuroCIS للتكنولوجيا' className='w-full h-auto object-cover rounded-lg shadow-md' />",
      "<p className='text-center text-sm text-text/60 mt-4'>صورة من معرض EuroCIS للتكنولوجيا في دوسلدورف</p>",
      "</div>",
      
      "<h2 className='text-2xl font-bold mt-12 mb-6'>أبرز ما شاهدناه في المعرض ✨</h2>",
      
      "<ul className='list-disc mr-6 my-6 space-y-3'>",
      ...
      "<div className='my-12 rounded-lg overflow-hidden'>",
      "<img src='/lovable-uploads/eurocis-2.png' alt='لقطة أخرى من معرض EuroCIS' className='w-full h-auto object-cover rounded-lg shadow-md' />",
      "<p className='text-center text-sm text-text/60 mt-4'>جانب من المناقشات والعروض التقنية في المعرض</p>",
      "</div>",
      ...
      "<div className='my-12 rounded-lg overflow-hidden'>",
      "<img src='/lovable-uploads/düsseldorf.jpg' alt='مدينة دوسلدورف' className='w-full h-auto object-cover rounded-lg shadow-md' />",
      "<p className='text-center text-sm text-text/60 mt-4'>مدينة دوسلدورف الألمانية المستضيفة للمعرض</p>",
      "</div>",
      
      "<div className='bg-primary/10 p-8 rounded-xl my-12'>",
      ...
      "<div className='bg-primary/20 p-8 rounded-xl mt-12 mb-8 text-center'>",
