...
const NewsArticle6 = () => {
  const articleData = {
    ...
    content: [
      ...
      "<h2 className='text-2xl font-bold mt-8 mb-4'>شارك عملائك لحظاتهم الهامة، وكافئهم على ولائهم، وأعد الاتصال بمن غابوا</h2>",
      ...
      "<h2 className='text-2xl font-bold mt-8 mb-4'>كيف تمنحك خاصية \"الحملات التسويقية المخصصة\" من \"دراهم\" ميزة تنافسية؟</h2>",
