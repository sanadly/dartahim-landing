  ...
  const milestones = [
    {
      year: "2018",
      title: "بداية الفكرة",
      description: "بدأت فكرة دراهم عندما لاحظ مؤسسو الشركة التحديات التي يواجهها الناس في ليبيا عند إجراء المعاملات المالية."
    },
    {
      year: "2020",
      title: "تأسيس الشركة",
      description: "تم تأسيس شركة دراهم رسميًا وبدأت في تطوير منصتها الأولية للمدفوعات الرقمية."
    },
    {
      year: "2021",
      title: "إطلاق النسخة التجريبية",
      description: "أطلقت دراهم النسخة التجريبية من تطبيقها للمدفوعات الرقمية، مع مجموعة محدودة من المستخدمين."
    },
    {
      year: "2022",
      title: "توسيع الخدمات",
      description: "توسعت دراهم لتشمل خدمات مالية متنوعة، بما في ذلك بطاقات الولاء وحلول الكاشباك."
    },
    {
      year: "2023",
      title: "الإطلاق الرسمي",
      description: "أطلقت دراهم خدماتها رسميًا للجمهور مع شراكات استراتيجية مع العديد من المؤسسات المالية في ليبيا."
    }
  ];
