...
const WhoAreWe = () => {
  ...
  const expertiseAreas = [{
    ...
    title: "خبرة عملية",
    description: "فريق عمل متخصص يملك خبرة عملية في مجال برامج الولاء والتسويق الرقمي تمتد لأكثر من 10 سنوات."
  }, {
    icon: <GraduationCap className="h-6 w-6" />,
    title: "خلفية أكاديمية",
    description: "نضم متخصصين حاصلين على شهادات أكاديمية عليا في مجالات التسويق الرقمي وتقنيات تعزيز ولاء العملاء."
  }, {
    icon: <Building className="h-6 w-6" />,
    title: "شراكات دولية",
    description: "نتعاون مع شركات ومؤسسات عالمية لتطبيق أفضل الممارسات في مجال برامج الولاء وحلول التسويق."
  }, {
    icon: <Lightbulb className="h-6 w-6" />,
    title: "البحث والتطوير",
    description: "نستثمر بشكل مستمر في البحث والتطوير لابتكار حلول برامج ولاء مخصصة تناسب احتياجات السوق الليبي."
  }];
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text/70 max-w-3xl mx-auto">
              تعرف على قصة دراهم ورؤيتنا لمستقبل برامج الولاء والتسويق الرقمي في ليبيا
            </p>
          </div>
          ...
          <div id="story" className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-20 items-center">
            <div className={cn("transition-all duration-700", isVisible.story ? "opacity-100 translate-x-0" : "opacity-0 translate-x-[-50px]")}>
              ...
              <p className="text-text/80 mb-4 leading-relaxed">
                تأسست شركة دراهم بواسطة مجموعة من الخبراء في مجال برامج الولاء والتسويق الرقمي، مستفيدين من خبراتهم في السوق الألماني وتعليمهم في أفضل الجامعات الألمانية. هدفنا هو تقديم حلول رقمية مبتكرة ومخصصة للشركات والمؤسسات في ليبيا، مستندين إلى أفضل الممارسات العالمية وخاصة من السوق الألماني المتطور.
              </p>
              <p className="text-text/80 mb-4 leading-relaxed">
                بدأت رحلتنا في عام 2020 بتطوير منصات متخصصة في أنظمة الولاء الرقمية وحلول التسويق المخصصة، مستفيدين من خبرتنا في السوق الألماني وعلاقاتنا مع كبرى شركات التكنولوجيا الرقمية في ألمانيا. ومع مرور الوقت توسعت خدماتنا لتشمل تطوير تطبيقات مخصصة وحلول استرداد نقدي متطورة ومنصات تسويق متكاملة.
              </p>
              <p className="text-text/80 leading-relaxed">
                نجمع بين الخبرة الألمانية والفهم العميق للسوق الليبي لتقديم حلول برامج ولاء وتسويق رقمي متكاملة مصممة خصيصاً لتلبية احتياجات عملك، مع الحفاظ على أعلى معايير الجودة والأمان المعتمدة عالمياً.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
            <div className={cn("feature-card p-8 transition-all duration-500", isVisible.story ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20")}>
              ...
              <p className="text-text/80 leading-relaxed">
                نطمح أن تكون دراهم الشريك الاستراتيجي الأول للشركات والمؤسسات في ليبيا في مجال حلول الولاء الرقمية وتطبيقات التسويق المخصصة، من خلال تقديم خدمات متميزة ومبتكرة تساهم في تطوير علاقة الشركات مع عملائها، وتمكين الشركات من النمو وتحقيق أهدافها.
              </p>
            </div>
            <div className={cn("feature-card p-8 transition-all duration-500 delay-100", isVisible.story ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20")}>
              ...
              <p className="text-text/80 leading-relaxed">
                مهمتنا هي تمكين الشركات والمؤسسات من تطوير علاقات أقوى مع عملائها من خلال توفير حلول رقمية متكاملة ومخصصة لبرامج الولاء والتسويق الرقمي، مع تطوير تطبيقات تناسب احتياجات كل عميل وتساعده على تحسين تجربة العملاء وزيادة المبيعات، مستندين إلى خبرتنا الأكاديمية والعملية في هذا المجال.
              </p>
            </div>
          </div>
