import { Info, Clock, Target, Briefcase, Heart, Shield, Users, TrendingUp, CheckCircle, Zap, Award, GraduationCap, Building, Lightbulb, Mail, LinkedinIcon, Twitter as TwitterIcon, Github } from "lucide-react";
...
const founders = [
    {
      ...
      socialLinks: {
        ...
        twitter: "https://twitter.com/darahimly",
        linkedin: "https://www.linkedin.com/company/darahimly/",
        github: "https://github.com/darahimly"
      }
    },
    {
      id: 2,
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div id="story" className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-20 items-center">
            <div className={cn("transition-all duration-700", isVisible.story ? "opacity-100 translate-x-0" : "opacity-0 translate-x-[-50px]")}>
              ...
              <p className="text-text/80 mb-4 leading-relaxed">
                بدأت رحلتنا في عام 2024 بتطوير منصات متخصصة في أنظمة الولاء الرقمية والتطبيقات المخصصة للشركات، مستفيدين من خبرتنا في السوق الألماني وعلاقاتنا مع كبرى شركات البرمجة في ألمانيا. ومع مرور الوقت توسعت خدماتنا لتشمل حلول الكاشباك المتطورة ومنصات التسويق الرقمية المتكاملة.
              </p>
