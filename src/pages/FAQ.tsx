...
const FAQ = () => {
  // Mock data for FAQs
  const faqCategories = [
    { id: 'loyalty-programs', name: '🏆 برامج الولاء' },
    { id: 'digital-payments', name: '💳 المدفوعات الرقمية' },
    { id: 'app-usage', name: '📱 استخدام التطبيق' },
    { id: 'customer-data', name: '📊 بيانات العملاء' },
    { id: 'technical', name: '🛠️ المسائل التقنية' },
    { id: 'pricing', name: '💰 الأسعار والاشتراكات' },
  ];
          ...
          <div className="max-w-4xl mx-auto">
                ...
                filteredFAQs.map((faq, index) => (
                  ...
                  >
                    <button
                      ...
                      className="w-full flex justify-between items-center p-5 text-right bg-background hover:bg-primary/5 transition-colors"
                    >
            ...
            <div className="mt-16 bg-primary/10 rounded-lg p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link 
                  to="/help-center" 
                  className="bg-white px-6 py-3 rounded-md border border-primary text-primary hover:bg-primary/5 transition-colors"
                >
                  مركز المساعدة
                </Link>
                <Link 
                  to="/help-center#contact" 
                  className="bg-primary px-6 py-3 rounded-md text-white hover:bg-primary/90 transition-colors"
                >
                  اتصل بنا
                </Link>
              </div>
