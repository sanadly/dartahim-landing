        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-right">
            ...
            <p className="text-text/70 text-center mb-8">
              نحن هنا لمساعدتك. اختر من بين الخيارات أدناه أو ابحث عن إجابة
              لسؤالك
            </p>
            ...
            <Tabs defaultValue="faq" className="mb-12">
              ...
              >
                <h2 className="text-xl font-bold mb-6 border-b pb-2 border-border">
                  الأسئلة الشائعة
                </h2>
                <p className="mb-4">
                  تصفح الأقسام الشائعة أدناه أو انتقل إلى{" "}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                  <Link
                    to="/faq#loyalty-programs"
                    className="block bg-background hover:bg-primary/5 transition-colors rounded-lg p-4 border border-border"
                  >
                    <h3 className="font-bold text-right">🏆 برامج الولاء</h3>
                    <p className="text-sm text-text/70 mt-1 text-right">
                      أسئلة حول تنفيذ وإدارة برامج الولاء
                    </p>
                  </Link>

                  <Link
                    to="/faq#digital-payments"
                    className="block bg-background hover:bg-primary/5 transition-colors rounded-lg p-4 border border-border"
                  >
                    ...
                    <p className="text-sm text-text/70 mt-1">
                      معلومات حول أنظمة الدفع وطرق التسوية
                    </p>
                  </Link>
                  ...
                  >
                    ...
                    <p className="text-sm text-text/70 mt-1 text-right">
                      مساعدة في استخدام تطبيق دراهم
                    </p>
                  </Link>

                  <Link
                    to="/faq#customer-data"
                    className="block bg-background hover:bg-primary/5 transition-colors rounded-lg p-4 border border-border"
                  >
                    <h3 className="font-bold">📊 بيانات العملاء</h3>
                    <p className="text-sm text-text/70 mt-1">
                      أسئلة حول إدارة وتحليل بيانات العملاء
                    </p>
                  </Link>
                </div>
              </TabsContent>
              ...
              >
                ...
                <p className="mb-8">
                  مجموعة من الأدلة التوضيحية لمساعدتك في استخدام منصة دراهم
                  بكفاءة
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-background rounded-lg p-4 border border-border">
                    ...
                    <p className="text-sm text-text/70 mt-1 mb-3">
                      دليل خطوة بخطوة لبدء استخدام النظام
                    </p>
                    <Link
                      to="#"
                  ...
                  <div className="bg-background rounded-lg p-4 border border-border">
                    ...
                    <p className="text-sm text-text/70 mt-1 mb-3">
                      شرح مفصل لاستخدام لوحة تحكم المشرف
                    </p>
                    <Link
                      to="#"
                      className="text-primary text-sm hover:underline"
                  ...
                  <div className="bg-background rounded-lg p-4 border border-border">
                    ...
                    <p className="text-sm text-text/70 mt-1 mb-3">
                      كيفية إنشاء وإدارة الحملات الترويجية
                    </p>
                    <Link
                      to="#"
                      className="text-primary text-sm hover:underline"
                  ...
                  <div className="bg-background rounded-lg p-4 border border-border">
                    ...
                    <p className="text-sm text-text/70 mt-1 mb-3">
                      استخدام تطبيق العملاء على الهاتف المحمول
                    </p>
                    <Link
                      to="#"
                      className="text-primary text-sm hover:underline"
              ...
              >
                ...
                <p className="mb-8">
                  يسعدنا الرد على استفساراتك. اختر طريقة الاتصال المناسبة لك
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-background rounded-lg p-5 border border-border">
                    ...
                    <p className="text-sm text-text/70 mt-1 mb-3">
                      متاح على مدار الساعة لمساعدتك في حل المشكلات التقنية
                    </p>
                    <p className="font-medium">+218 94‑6753753</p>
                  ...
                  <div className="bg-background rounded-lg p-5 border border-border">
                    ...
                    <p className="text-sm text-text/70 mt-1 mb-3">
                      استفسر عن الخدمات والباقات والأسعار
                    </p>
                    <p className="font-medium">+218 94‑6753753</p>
              ...
              >
                ...
                <p className="mb-8">
                  أرسل طلبك وسيقوم فريق الدعم لدينا بالرد عليك في أقرب وقت ممكن
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  <h3 className="font-bold">
                    كيفية إعداد برنامج الولاء للمرة الأولى
                  </h3>
                  <p className="text-sm text-text/70 mt-2">
                    دليل شامل للمبتدئين لإعداد برنامج ولاء فعّال
                  </p>
                </Link>
                ...
                >
                  <h3 className="font-bold">
                    استيراد بيانات العملاء من أنظمة أخرى
                  </h3>
                  <p className="text-sm text-text/70 mt-2">
                    خطوات نقل البيانات من نظام آخر إلى منصة دراهم
                  </p>
                </Link>
                ...
                >
                  ...
                  <p className="text-sm text-text/70 mt-2">
                    إصلاح المشكلات المتعلقة بتسجيل الدخول والحسابات
                  </p>
                </Link>
              </div>
            </div>
