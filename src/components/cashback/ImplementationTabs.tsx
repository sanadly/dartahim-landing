...
const ImplementationTabs = () => {
  ...
  const implementationTabs = [
    {
      ...
      content: {
        ...
        features: [
          "تحديد نقاط التفاعل مع العملاء المستهدفين",
          "تحليل سلوك المشتريات وأنماط الإنفاق",
          "دراسة المنافسين واتجاهات السوق"
        ],
        stats: {
    ...
    },
    {
      ...
      content: {
        ...
        features: [
          "واجهات مستخدم بسيطة وجذابة",
          "تكامل مع أنظمة نقاط البيع والتجارة الإلكترونية",
          "خيارات استرداد متعددة (نقدي، نقاط، قسائم)"
        ],
        stats: {
          title: "معدل التفاعل",
          value: "3x",
    ...
    },
    {
      ...
      content: {
        ...
        features: [
          "خطة إطلاق متكاملة وتدريب فريقك",
          "لوحات تحكم وتقارير أداء مفصلة",
    ...
    },
    {
      ...
      content: {
        ...
        features: [
          ...
          "تحديثات دورية للنظام وإضافة ميزات جديدة",
          "تحليلات مستمرة واقتراحات للتحسين"
        ],
        stats: {
          title: "رضا العملاء",
          value: "95%",
  ...
  const caseStudy = {
    ...
    results: [
      { metric: "زيادة متوسط قيمة المشتريات", value: "32%" },
      { metric: "زيادة معدل تكرار الزيارات", value: "28%" },
      { metric: "زيادة إجمالي المبيعات", value: "47%" },
      { metric: "عائد الاستثمار", value: "340%" }
    ]
  };
    ...
    <div className="bg-background rounded-xl p-6 shadow-md">
      ...
      <div className="flex mb-8 bg-muted/40 rounded-full p-1 border overflow-x-auto">
        {implementationTabs.map((tab) => (
          <button
            ...
            className={cn(
              "flex items-center justify-center gap-2 py-2 px-4 rounded-full transition-all flex-1 whitespace-nowrap text-sm md:text-base",
              activeTab === tab.id 
                ? "bg-primary text-white shadow-sm" 
                : "hover:bg-background/80 text-text/70"
            )}
          >
            {tab.icon}
            <span>{tab.title}</span>
        ...
        <div className="space-y-6">
          <div>
            ...
            <ul className="space-y-2">
              {implementationTabs[activeTab].content.features.map((feature, idx) => (
      ...
      <div className="mt-5 pt-4 border-t border-dashed border-primary/20">
        ...
        <div className="relative h-0.5 bg-text/20 -mt-[9px] z-0">
          <div 
            className="absolute top-0 right-0 h-full bg-primary transition-all" 
